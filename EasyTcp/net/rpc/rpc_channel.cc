...
#include "EasyTcp/common/msg_id_util.h"
#include "EasyTcp/common/error_code.h"
...
namespace EasyTcp
{
                              ...
                              google::protobuf::Message *response, google::protobuf::Closure *done)
  {
    ...
    std::shared_ptr<EasyTcp::TinyPBProtocol> req_protocol = std::make_shared<EasyTcp::TinyPBProtocol>();
                        ...
                        getTcpClient()->writeMessage(req_protocol, [req_protocol, this, my_controller](AbstractProtocol::s_ptr) mutable
                                                     {
                                                       ...
                                                       getTcpClient()->readMessage(req_protocol->m_msg_id, [this, my_controller](AbstractProtocol::s_ptr msg) mutable
                                                                                   {
                                                                                     std::shared_ptr<EasyTcp::TinyPBProtocol> rsp_protocol = std::dynamic_pointer_cast<EasyTcp::TinyPBProtocol>(msg);
